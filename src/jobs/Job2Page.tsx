          ...
          <div className="relative px-6 pt-24 pb-20 sm:pt-32 lg:static lg:px-8 lg:py-48">
            <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
              ...
              <h2 className="text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl">
                Polierer / Vorarbeiter (m/w/d)
              </h2>
              <p className="mt-6 text-lg/8 text-gray-600">
                Als Polierer bzw. Vorarbeiter im Tief- und Kabelbau (m/w/d)
                übernehmen Sie die fachliche Führung des Baustellenteams und
                sind maßgeblich für die Umsetzung der täglichen Arbeitsabläufe
                verantwortlich. Sie koordinieren Personal und Geräte, überwachen
                die Einhaltung von Plänen, Sicherheitsvorschriften und
                Qualitätsstandards und unterstützen die Bauleitung bei der
                Vorbereitung und Dokumentation der Arbeiten. Durch Ihre
                Erfahrung im Tiefbau sowie Ihre lösungsorientierte und
                praxisnahe Arbeitsweise stellen Sie sicher, dass Projekte
                effizient, termingerecht und in hoher Ausführungsqualität
                umgesetzt werden.
              </p>
              <ul
                role="list"
