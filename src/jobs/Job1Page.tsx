          ...
          <div className="relative px-6 pt-24 pb-20 sm:pt-32 lg:static lg:px-8 lg:py-48">
            <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
              ...
              <h2 className="text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl dark:text-white">
                Bauleiter Tief- und Kabelbau (m/w/d)
              </h2>
              <p className="mt-6 text-lg/8 text-gray-600 dark:text-gray-400">
                Als Bauleiter im Tief- und Kabelbau (m/w/d) übernehmen Sie die
                verantwortungsvolle Steuerung und Organisation unserer
                Bauprojekte – von der Planung über die Koordination der Gewerke
                bis hin zur erfolgreichen Abnahme. Sie sorgen für einen
                reibungslosen Ablauf auf der Baustelle, kontrollieren Qualität,
                Termine und Kosten und sind zentraler Ansprechpartner für
                Auftraggeber, Partnerfirmen und das Baustellenteam. Mit Ihrem
                technischen Know-how und Ihrer lösungsorientierten Arbeitsweise
                tragen Sie wesentlich zum sicheren und effizienten Ausbau
                moderner Infrastruktur bei.
              </p>
              <ul
                role="list"
